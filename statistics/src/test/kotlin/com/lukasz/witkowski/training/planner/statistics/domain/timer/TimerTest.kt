...
class TimerTest {
    ...
    @Test
    fun `first emitted time is equal to the initial value`() =
    ...
    @Test
    @Suppress("LongMethod")
    fun `timer emits 3 values withing 3 seconds`() =
        runTest(testDispatcher) {
            givenTimerController(SECOND_IN_MILLIS)
    ...
    @Test
    @Suppress("LongMethod")
    fun `timer emits 3 seconds and is finished`() =
        runTest(testDispatcher) {
            givenTimerController(SECOND_IN_MILLIS)
    ...
    @Test
    @Suppress("LongMethod")
    fun `start timer after it has finished`() =
        runTest(testDispatcher) {
            givenTimerController(SECOND_IN_MILLIS)
            val time = Time(seconds = 3)
            val testResults = mutableListOf<Time>()
    ...
    @Test
    fun `stop not started timer has not effect`() =
        runTest(testDispatcher) {
            givenTimerController(SECOND_IN_MILLIS)
            val time = Time(seconds = 3)
    ...
    @Test
    @Suppress("LongMethod")
    fun `after pause new values are not emitted`() =
        runTest(testDispatcher) {
            givenTimerController(SECOND_IN_MILLIS)
            val time = Time(seconds = 5)
            val resultList = mutableListOf<Time>()
    ...
    @Test
    @Suppress("LongMethod")
    fun `resume after pause emits consecutive time till finished`() =
        runTest(testDispatcher) {
            givenTimerController(SECOND_IN_MILLIS)
            val time = Time(seconds = 5)
            val resultList = mutableListOf<Time>()
    ...
    @Test
    @Suppress("LongMethod")
    fun `resume start timer if it was not started yet`() =
        runTest(testDispatcher) {
            givenTimerController(SECOND_IN_MILLIS)
            val time = Time(seconds = 5)
            val resultList = mutableListOf<Time>()
